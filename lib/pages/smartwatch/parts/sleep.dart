...
class _SleepPageState extends State<SleepPage> {
  ...
  Widget _contentNoData() => Text('No Data to show');
  Widget _contentNotFetched() => Text('Press the download button to fetch data');
  Widget _authorizationNotGranted() => Text('''Authorization not given.
